 ...
 * 检查长度 cnt 是否大于 1，如果大于 1，需要将数字拆分存储。由于简单的实现中，我们只能从个位开始处理 cnt，
 * 因此需要使用 start 和 end 记录下存储数字的部分，再处理完 cnt 后，将 [start, end)部分进行翻转，并更新 j 指针；
...
public class 压缩字符串 {
    ...
    public static void main(String[] args) {
        ...
        压缩字符串 ys=new 压缩字符串();
        int compress = ys.compress(chars);
