 ...
 * 什么意思呢？
 * 假设有起始石子 a 和 b，且两者重量关系为 a \geq ba≥b，那么首先会将 a 放入「正号堆」，将 b 放入「负号堆」。重放回操作可以看作产生一个新的重量为 a−b 的“虚拟石子”，将来这个“虚拟石子”也会参与某次合并操作，也会被添加 +/-+/− 符号：
 ...
 * 这就将问题彻底切换为 01 背包问题：从 stones 数组中选择，凑成总和不超过 的最大价值。
 * 其中「成本」&「价值」均为数值本身。
 * 整理一下：
...
public class 最后一块石头的重量二 {
    public int lastStoneWeightII(int[] stones) {
        ...
        return Math.abs(sum -f[len][t] - f[len][t]);
    }
}
